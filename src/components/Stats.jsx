    ...
    <div id="stats" className="py-20 space-y-16">
      ...
      <section>
        ...
        <div className="flex flex-col items-center space-y-4">
          <img 
            src="https://github-readme-stats.vercel.app/api?username=wiruwiru&show_icons=true&theme=react&rank_icon=github&border_radius=10" 
            alt="GitHub Stats" 
            className="w-full max-w-[390px]"/>
          <img 
            src="https://github-readme-stats.vercel.app/api/top-langs/?username=wiruwiru&langs_count=8&layout=compact&theme=react&border_radius=10&size_weight=0.5&count_weight=0.5" 
            alt="Top Languages" 
            className="w-full max-w-[390px]"/>
        </div>
      </section>
